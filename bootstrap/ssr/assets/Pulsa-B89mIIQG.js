...
const ProviderBadge = ({ provider }) => {
  ...
  return /* @__PURE__ */ jsx("span", { className: `px-2.5 py-1 rounded-md text-[9px] font-black uppercase tracking-widest border shadow-sm animate-in zoom-in ${c}`, children: provider });
};
function Pulsa({ auth, groupedProducts, userBalance }) {
  ...
  const handleSaveFav = () => {
    ...
    Swal.fire({
      ...
      input: "text",
      inputPlaceholder: "Misal: Nomor Istri",
      ...
      if (res.isConfirmed && res.value) {
        ...
        localStorage.setItem("amifi_pulsa_favs", JSON.stringify(newFavs));
  ...
  const handleOrder = () => {
    ...
    Swal.fire({
      ...
      if (res.isConfirmed) {
        localStorage.setItem("last_pulsa_trx", JSON.stringify({ number: cleanPhone, time: (/* @__PURE__ */ new Date()).getTime() }));
  ...
  return /* @__PURE__ */ jsxs(AuthenticatedLayout, { user: auth.user, children: [
    /* @__PURE__ */ jsx(Head, { title: "Isi Pulsa - MilaStore" }),
    ...
    /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-[#F4F7FB] font-['Outfit'] pb-40", children: [
      /* @__PURE__ */ jsxs("div", { className: "p-8 pb-20 text-white shadow-xl relative overflow-hidden rounded-b-[45px]", style: { background: "linear-gradient(135deg, #06b6d4 0%, #4f46e5 100%)" }, children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "max-w-md mx-auto flex justify-between items-center relative z-10", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "text-center", children: [
            /* @__PURE__ */ jsx("h1", { className: "text-xl font-black tracking-tight m-0 uppercase drop-shadow-md", children: "Isi Pulsa" }),
        ...
        /* @__PURE__ */ jsx("i", { className: "fa-solid fa-bolt absolute right-5 -bottom-5 text-8xl text-white opacity-10 -rotate-12" })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "max-w-md mx-auto px-5 -mt-12 relative z-20", children: [
        /* @__PURE__ */ jsxs("div", { className: "bg-white rounded-[32px] p-6 shadow-[0_15px_40px_rgba(0,0,0,0.05)] border border-slate-50 mb-6 relative overflow-hidden", children: [
          /* @__PURE__ */ jsx("div", { className: "absolute -top-10 -right-10 w-32 h-32 bg-cyan-50 rounded-full blur-2xl" }),
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex items-center border-b-2 border-slate-100 focus-within:border-cyan-500 transition-all pb-2 gap-3 relative z-10", children: [
            /* @__PURE__ */ jsx(
              "input",
              {
                type: "tel",
            ...
            phone.length >= 10 && /* @__PURE__ */ jsx("i", { className: "fa-solid fa-check-circle absolute right-14 top-2 text-cyan-500 text-lg animate-in zoom-in" }),
            /* @__PURE__ */ jsx("button", { onClick: handleContactPicker, className: "w-12 h-12 bg-cyan-50 text-cyan-500 rounded-[16px] flex items-center justify-center shadow-sm active:scale-95 transition-transform", children: /* @__PURE__ */ jsx("i", { className: "fa-solid fa-address-book text-xl" }) })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-center mt-4 relative z-10", children: [
            /* @__PURE__ */ jsxs("button", { onClick: handleSaveFav, disabled: phone.length < 10, className: "text-[10px] font-black uppercase tracking-widest text-slate-400 hover:text-cyan-500 transition-colors disabled:opacity-50", children: [
              /* @__PURE__ */ jsx("i", { className: "fa-regular fa-bookmark mr-1.5 text-sm" }),
              " Simpan"
            ] }),
            /* @__PURE__ */ jsxs("button", { onClick: () => setShowFavModal(true), className: "text-[10px] font-black uppercase tracking-widest text-cyan-500 bg-cyan-50 px-4 py-2 rounded-xl hover:bg-cyan-100 transition-colors shadow-sm border border-cyan-100", children: [
              /* @__PURE__ */ jsx("i", { className: "fa-solid fa-list-ul mr-1.5" }),
              " Favorit"
            ] })
          ] })
        ] }),
        /* @__PURE__ */ jsx("div", { className: "grid grid-cols-2 gap-3", children: phone.length < 4 ? /* @__PURE__ */ jsxs("div", { className: "col-span-2 bg-white/60 backdrop-blur-md rounded-[32px] p-12 text-center border border-slate-100 shadow-sm animate-in fade-in", children: [
          /* @__PURE__ */ jsx("div", { className: "w-20 h-20 bg-gradient-to-tr from-cyan-50 to-indigo-50 text-cyan-300 rounded-full flex items-center justify-center text-4xl mx-auto mb-5 shadow-inner", children: /* @__PURE__ */ jsx("i", { className: "fa-solid fa-keyboard" }) }),
          /* @__PURE__ */ jsx("h4", { className: "font-black text-slate-700 mb-1.5", children: "Ketik Nomor HP" }),
          /* @__PURE__ */ jsx("p", { className: "font-bold text-[11px] text-slate-400 leading-relaxed px-4", children: "Pilihan nominal pulsa otomatis muncul setelah Anda mengetik awalan nomor." })
        ] }) : activeProducts.length === 0 ? /* @__PURE__ */ jsxs("div", { className: "col-span-2 bg-rose-50 rounded-[32px] p-10 text-center border border-rose-100 mt-2 animate-in fade-in zoom-in", children: [
          /* @__PURE__ */ jsx("div", { className: "w-16 h-16 bg-white text-rose-400 rounded-full flex items-center justify-center text-3xl mx-auto mb-4 shadow-sm", children: /* @__PURE__ */ jsx("i", { className: "fa-solid fa-triangle-exclamation" }) }),
          /* @__PURE__ */ jsx("h4", { className: "font-black text-rose-700 mb-1", children: "Produk Kosong" }),
          /* @__PURE__ */ jsxs("p", { className: "font-bold text-[11px] text-rose-500/70", children: [
            "Maaf, layanan pulsa ",
            provider || "ini",
            " sedang tidak tersedia dari server."
          ] })
          ...
          return /* @__PURE__ */ jsxs("div", { onClick: () => setSelected(p), className: `relative p-5 rounded-[24px] transition-all cursor-pointer border-2 bg-white flex flex-col justify-between h-[115px] overflow-hidden ${isSelected ? "border-cyan-500 shadow-[0_10px_25px_rgba(6,182,212,0.25)] scale-[1.02] ring-4 ring-cyan-50 z-10" : "border-slate-100 shadow-sm hover:border-cyan-200 hover:-translate-y-1"}`, children: [
            /* @__PURE__ */ jsx("div", { className: "absolute top-0 right-0 bg-red-500 text-white text-[8px] font-black px-2 py-0.5 rounded-bl-lg shadow-sm tracking-widest", children: "DISKON 5%" }),
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsxs("div", { className: `text-[9px] font-black uppercase tracking-widest mb-1 flex items-center gap-1 ${isSelected ? "text-cyan-500" : "text-slate-400"}`, children: [
                /* @__PURE__ */ jsx("i", { className: "fa-solid fa-bolt text-[8px]" }),
                " PULSA ",
                provider
              ] }),
              /* @__PURE__ */ jsx("div", { className: "text-[22px] font-black text-slate-800 tracking-tighter leading-none truncate", children: nominalTampil })
            ] }),
            /* @__PURE__ */ jsxs("div", { children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: `font-black text-[15px] ${isSelected ? "text-cyan-600" : "text-slate-500"}`, children: [
                "Rp ",
      ...
      selected && phone.length >= 10 && /* @__PURE__ */ jsxs("div", { className: "fixed bottom-0 left-0 right-0 p-5 bg-white/95 backdrop-blur-xl border-t border-slate-100 flex justify-between items-center shadow-[0_-10px_40px_rgba(0,0,0,0.06)] z-50 animate-in slide-in-from-bottom rounded-t-[35px]", children: [
        /* @__PURE__ */ jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsxs("h3", { className: "text-2xl font-black text-cyan-600 tracking-tighter drop-shadow-sm", children: [
            "Rp ",
            formatRp(selected.harga_jual)
          ] })
        ] }),
        /* @__PURE__ */ jsxs("button", { onClick: handleOrder, disabled: processing, className: "bg-gradient-to-r from-cyan-500 to-indigo-600 text-white px-8 py-3.5 rounded-[16px] font-black text-[11px] uppercase tracking-widest shadow-[0_8px_20px_rgba(6,182,212,0.3)] active:scale-95 transition-all disabled:opacity-50 flex items-center gap-2", children: [
          "BAYAR SEKARANG ",
          /* @__PURE__ */ jsx("i", { className: "fa-solid fa-fingerprint text-sm ml-1" })
        ] })
      ] }),
      showFavModal && /* @__PURE__ */ jsx("div", { className: "fixed inset-0 bg-black/60 backdrop-blur-sm z-[100] flex justify-center items-end sm:items-center p-0 sm:p-5 animate-in fade-in", children: /* @__PURE__ */ jsxs("div", { className: "bg-white w-full max-w-md rounded-t-[32px] sm:rounded-[32px] p-6 shadow-2xl animate-in slide-in-from-bottom max-h-[85vh] flex flex-col border border-white/20", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-center mb-6", children: [
          /* @__PURE__ */ jsxs("h4", { className: "font-black text-slate-800 text-lg m-0 flex items-center gap-2", children: [
            /* @__PURE__ */ jsx("i", { className: "fa-solid fa-address-book text-cyan-500" }),
            "Nomor Favorit"
          ] }),
        ...
        /* @__PURE__ */ jsx("div", { className: "overflow-y-auto custom-scrollbar flex-1 pr-1 pb-4", children: favorites.length === 0 ? /* @__PURE__ */ jsxs("div", { className: "text-center py-12 opacity-60", children: [
        ...
        ] }) : /* @__PURE__ */ jsx("div", { className: "grid gap-3", children: favorites.map((fav) => /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-center p-4 border-2 border-slate-100 rounded-[20px] hover:border-cyan-300 transition-all bg-white hover:shadow-md group cursor-pointer", onClick: () => {
          setPhone(fav.no);
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex-1 min-w-0 pr-2", children: [
            ...
            /* @__PURE__ */ jsx("div", { className: "font-mono text-cyan-600 font-bold tracking-widest text-[11px] mt-1 bg-cyan-50 px-2 py-0.5 rounded w-max", children: formatDisplayPhone(fav.no) })
          ] }),
