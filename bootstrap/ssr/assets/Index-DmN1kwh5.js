...
function BroadcastIndex({ auth }) {
  ...
  const submit = (e) => {
    e.preventDefault();
    let confirmHtml = data.is_autopilot ? `<div class="text-sm text-slate-300 mt-2">Pesan akan ditembakkan otomatis<br/><b class="text-sky-400 text-lg">TIAP HARI JAM ${data.time} WIB</b></div>` : `<div class="text-sm text-slate-300 mt-2">Pesan akan <b class="text-rose-400">LANGSUNG DITEMBAKKAN</b><br/>ke semua member sekarang juga.</div>`;
    Swal.fire({
        ...
        /* @__PURE__ */ jsxs("form", { onSubmit: submit, className: "cyber-card p-6 md:p-8 rounded-[32px]", children: [
          ...
          data.is_autopilot && /* @__PURE__ */ jsxs("div", { className: "mb-6 p-5 bg-indigo-900/20 border border-indigo-500/30 rounded-[24px] animate-in zoom-in-95 duration-300 relative overflow-hidden", children: [
            ...
            /* @__PURE__ */ jsxs("label", { className: "text-[10px] font-black text-indigo-300 uppercase tracking-widest mb-3 block relative z-10 flex items-center justify-center gap-2", children: [
              /* @__PURE__ */ jsx("i", { className: "fa-regular fa-clock text-base" }),
              " Waktu Tembak (Setiap Hari)"
            ] }),
            /* @__PURE__ */ jsx(
              "input",
              {
            ...
            /* @__PURE__ */ jsx("p", { className: "text-[9px] text-indigo-400/70 font-bold mt-3 text-center uppercase tracking-widest relative z-10", children: "*Sistem akan mengeksekusi pesan tiap jam tersebut secara otomatis." })
          ] }),
          ...
          /* @__PURE__ */ jsxs("div", { className: "mb-6", children: [
            ...
            /* @__PURE__ */ jsx("div", { className: "flex justify-end mt-2", children: /* @__PURE__ */ jsxs("span", { className: "text-[9px] font-bold text-slate-500 uppercase tracking-widest", children: [
              /* @__PURE__ */ jsx("i", { className: "fa-brands fa-markdown mr-1" }),
