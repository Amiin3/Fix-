    ...
    /* @__PURE__ */ jsxs("div", { className: "max-w-6xl mx-auto space-y-6", children: [
      /* @__PURE__ */ jsxs("div", { className: "bg-white p-5 rounded-xl shadow-md flex flex-col md:flex-row justify-between items-center border-l-4 border-blue-600", children: [
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("h2", { className: "text-2xl font-black text-gray-800 tracking-tight", children: "🎯 COMMAND CENTER (KAJE)" }),
          /* @__PURE__ */ jsx("p", { className: "text-sm text-gray-500", children: "Mode Serangan: Full Auto-Pilot Tanpa Limit" })
        ] }),
        /* @__PURE__ */ jsx("div", { className: "mt-4 md:mt-0 flex space-x-3", children: /* @__PURE__ */ jsx(
          "button",
          {
            ...
            children: isRunning ? "🛑 STOP PENEMBAKAN" : "🚀 MULAI SERANGAN"
          }
        ) })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "bg-gray-900 rounded-xl shadow-2xl overflow-hidden border border-gray-700", children: [
        /* @__PURE__ */ jsxs("div", { className: "bg-gray-800 px-4 py-3 flex justify-between items-center border-b border-gray-700", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center space-x-2", children: [
            ...
            /* @__PURE__ */ jsx("span", { className: "ml-2 text-gray-400 font-mono text-sm tracking-widest", children: "LIVE_RADAR_LOG" })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "space-x-2", children: [
            /* @__PURE__ */ jsx("button", { onClick: () => handleAction("refresh_all"), className: "text-xs bg-indigo-600 hover:bg-indigo-700 text-white px-3 py-1.5 rounded shadow", children: "🔄 Refresh Zombi" }),
            /* @__PURE__ */ jsx("button", { onClick: () => handleAction("cancel_all"), className: "text-xs bg-red-600 hover:bg-red-700 text-white px-3 py-1.5 rounded shadow", children: "🧹 Sapu Bersih" })
          ] })
        ] }),
      ...
      /* @__PURE__ */ jsxs("div", { className: "bg-white rounded-xl shadow-md overflow-hidden border border-gray-200", children: [
        /* @__PURE__ */ jsxs("div", { className: "bg-gray-50 px-5 py-4 border-b border-gray-200 flex justify-between items-center", children: [
          /* @__PURE__ */ jsx("h3", { className: "font-bold text-gray-700 text-lg", children: "📋 Daftar Target Operasi" }),
        ...
        /* @__PURE__ */ jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxs("table", { className: "w-full text-sm text-left text-gray-600", children: [
          /* @__PURE__ */ jsx("thead", { className: "text-xs text-gray-500 uppercase bg-gray-100/50", children: /* @__PURE__ */ jsxs("tr", { children: [
            ...
            /* @__PURE__ */ jsx("th", { className: "px-5 py-3 font-semibold text-right", children: "Aksi Darurat" })
          ] }) }),
          /* @__PURE__ */ jsx("tbody", { className: "divide-y divide-gray-200", children: queue.length === 0 ? /* @__PURE__ */ jsx("tr", { children: /* @__PURE__ */ jsx("td", { colSpan: "5", className: "text-center py-8 text-gray-400 font-medium", children: "✨ Radar bersih. Tidak ada target." }) }) : queue.map((item) => /* @__PURE__ */ jsxs("tr", { className: "hover:bg-blue-50/50 transition-colors", children: [
            ...
            /* @__PURE__ */ jsx("td", { className: "px-5 py-3", children: /* @__PURE__ */ jsx("span", { className: `px-2.5 py-1 rounded-full text-xs font-bold shadow-sm
                                                ${item.status === "Menunggu" ? "bg-yellow-100 text-yellow-700 border border-yellow-200" : item.status === "Proses_API" ? "bg-blue-100 text-blue-700 border border-blue-200" : "bg-gray-100 text-gray-700 border border-gray-200"}`, children: item.status === "Proses_API" ? "Sedang Digempur" : item.status }) }),
            /* @__PURE__ */ jsxs("td", { className: "px-5 py-3 text-right whitespace-nowrap", children: [
              /* @__PURE__ */ jsx("button", { onClick: () => handleAction("skip", item.ref), className: "bg-yellow-500 hover:bg-yellow-600 text-white px-3 py-1.5 rounded text-xs font-medium mr-2 transition-colors shadow-sm", children: "Tendang" }),
              /* @__PURE__ */ jsx("button", { onClick: () => handleAction("cancel_ref", item.ref), className: "bg-red-500 hover:bg-red-600 text-white px-3 py-1.5 rounded text-xs font-medium transition-colors shadow-sm", children: "Cancel" })
            ] })
          ] }, item.id)) })
        ] }) })
      ] })
