...
function Data({ auth, groupedProducts, userBalance }) {
  ...
  const handleOrder = () => {
    ...
    Swal.fire({
      ...
      if (res.isConfirmed) {
        localStorage.setItem("last_data_trx", JSON.stringify({ number: cleanPhone, time: (/* @__PURE__ */ new Date()).getTime() }));
        ...
        post(route("order.data.store"), {
          ...
          onSuccess: () => {
            Swal.fire({
              icon: "success",
              title: '<div class="text-xl font-black text-slate-800 mt-2">Paket Meluncur!</div>',
  ...
  return /* @__PURE__ */ jsxs(AuthenticatedLayout, { user: auth.user, children: [
    /* @__PURE__ */ jsx(Head, { title: "Paket Data - MilaStore" }),
    ...
    /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-[#F4F7FB] font-['Outfit'] pb-[140px] md:pb-40", children: [
      /* @__PURE__ */ jsxs("div", { className: "p-8 pb-20 text-white shadow-xl relative overflow-hidden rounded-b-[45px]", style: { background: "linear-gradient(135deg, #4f46e5 0%, #a855f7 100%)" }, children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "max-w-md mx-auto flex justify-between items-center relative z-10", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "text-center", children: [
            /* @__PURE__ */ jsx("h1", { className: "text-xl font-black tracking-tight m-0 uppercase drop-shadow-md", children: "Paket Data" }),
        ...
        /* @__PURE__ */ jsx("i", { className: "fa-solid fa-satellite-dish absolute right-5 -bottom-5 text-8xl text-white opacity-10 -rotate-12" })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "max-w-md mx-auto px-5 -mt-12 relative z-20", children: [
        /* @__PURE__ */ jsxs("div", { className: "bg-white rounded-[32px] p-6 shadow-[0_15px_40px_rgba(0,0,0,0.05)] border border-slate-50 mb-5 relative overflow-hidden focus-within:border-indigo-500 focus-within:ring-4 focus-within:ring-indigo-50 transition-all", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex items-center border-b-2 border-slate-100 pb-2 gap-3 relative z-10", children: [
            /* @__PURE__ */ jsx(
              "input",
              {
                type: "tel",
            ...
            phone.length >= 10 && /* @__PURE__ */ jsx("i", { className: "fa-solid fa-check-circle absolute right-14 top-2 text-indigo-500 text-lg animate-in zoom-in" }),
            /* @__PURE__ */ jsx("button", { onClick: handleContactPicker, className: "w-12 h-12 bg-indigo-50 text-indigo-500 rounded-[16px] flex items-center justify-center shadow-sm active:scale-95 transition-transform", children: /* @__PURE__ */ jsx("i", { className: "fa-solid fa-address-book text-xl" }) })
          ] })
        ] }),
        categories.length > 1 && /* @__PURE__ */ jsx("div", { className: "flex overflow-x-auto gap-2.5 mb-5 no-scrollbar pb-2 snap-x px-1", children: categories.map((cat) => /* @__PURE__ */ jsx(
          "button",
          {
            onClick: () => {
        ...
        /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 gap-3", children: phone.length < 4 ? /* @__PURE__ */ jsxs("div", { className: "text-center py-12 opacity-60 bg-white/50 backdrop-blur-sm rounded-[32px] border-2 border-dashed border-slate-200 mt-2 shadow-sm animate-in fade-in", children: [
          /* @__PURE__ */ jsx("div", { className: "w-20 h-20 bg-indigo-50 text-indigo-300 rounded-full flex items-center justify-center text-4xl mx-auto mb-4", children: /* @__PURE__ */ jsx("i", { className: "fa-solid fa-keyboard" }) }),
          /* @__PURE__ */ jsxs("p", { className: "font-bold text-[11px] uppercase tracking-widest text-slate-500", children: [
            "Ketik nomor (08xx)",
            /* @__PURE__ */ jsx("br", {}),
            "untuk memunculkan paket."
          ] })
        ] }) : currentViewProducts.length === 0 ? /* @__PURE__ */ jsxs("div", { className: "text-center py-12 bg-white rounded-[32px] border border-slate-100 shadow-sm animate-in zoom-in", children: [
          /* @__PURE__ */ jsx("div", { className: "w-16 h-16 bg-slate-50 text-slate-300 rounded-full flex items-center justify-center text-3xl mx-auto mb-4", children: /* @__PURE__ */ jsx("i", { className: "fa-solid fa-box-open" }) }),
          /* @__PURE__ */ jsx("p", { className: "font-black text-slate-500 uppercase tracking-widest text-[10px]", children: "Paket Kosong." })
          ...
          return /* @__PURE__ */ jsxs("div", { onClick: () => setSelected(p), className: `p-5 rounded-[24px] transition-all cursor-pointer relative overflow-hidden border-2 ${isSelected ? "bg-indigo-50 border-indigo-500 shadow-[0_10px_25px_rgba(79,70,229,0.25)] scale-[1.02] z-10 ring-4 ring-indigo-50" : "bg-white border-slate-100 shadow-sm hover:border-indigo-200 hover:-translate-y-1"}`, children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-start mt-2", children: [
              /* @__PURE__ */ jsxs("div", { className: "w-3/4 pr-4", children: [
                /* @__PURE__ */ jsxs("div", { className: "text-[8px] font-black text-indigo-400 bg-indigo-100/50 px-2 py-0.5 rounded uppercase tracking-widest mb-2 w-max border border-indigo-100", children: [
                  "Kode: ",
                  p.kode_layanan
                ] }),
                /* @__PURE__ */ jsx("div", { className: `font-black leading-snug text-sm tracking-tight ${isSelected ? "text-indigo-800" : "text-slate-800"}`, children: displayName })
              ] }),
              /* @__PURE__ */ jsxs("div", { className: "text-right flex flex-col justify-end", children: [
                ...
                /* @__PURE__ */ jsxs("div", { className: `text-[16px] font-black tracking-tight ${isSelected ? "text-indigo-600" : "text-indigo-500"}`, children: [
                  "Rp ",
      ...
      selected && phone.length >= 10 && /* @__PURE__ */ jsx("div", { className: "fixed bottom-[90px] md:bottom-6 left-4 right-4 max-w-md mx-auto z-50 animate-in slide-in-from-bottom-5", children: /* @__PURE__ */ jsxs("div", { className: "bg-slate-900 rounded-[32px] p-2 pl-6 pr-2 shadow-[0_20px_40px_rgba(0,0,0,0.3)] flex justify-between items-center border border-slate-700/50 backdrop-blur-xl", children: [
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("p", { className: "text-[9px] font-black text-slate-400 uppercase tracking-widest mb-0.5", children: "Total Bayar" }),
          /* @__PURE__ */ jsxs("h3", { className: "text-xl font-black text-white tracking-tight", children: [
            "Rp ",
            formatRp(selected.harga_jual)
          ] })
        ] }),
        /* @__PURE__ */ jsxs("button", { onClick: handleOrder, disabled: processing, className: "bg-gradient-to-r from-indigo-500 to-purple-600 hover:from-indigo-600 hover:to-purple-700 text-white px-6 py-4 rounded-[24px] font-black text-xs uppercase tracking-widest shadow-lg shadow-indigo-500/30 active:scale-95 transition-all disabled:opacity-50 flex items-center gap-2", children: [
          processing ? "PROSES..." : "BAYAR",
          " ",
          /* @__PURE__ */ jsx("i", { className: "fa-solid fa-arrow-right" })
        ] })
      ] }) })
    ] })
  ] });
